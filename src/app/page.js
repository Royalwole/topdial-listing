...
export default async function Home() {
  ...
  return (
    <div>
      {/* Hero Section */}
      <div className='flex flex-col gap-6 p-6 sm:p-12 lg:p-28 px-3 max-w-6xl mx-auto'>
        <h1 className='text-slate-700 font-bold text-2xl sm:text-3xl lg:text-6xl'>
          Find your next <span className='text-slate-500'>perfect</span>
          <br />
          place with ease
        </h1>
        <div className='text-gray-400 text-xs sm:text-sm'>
          Topdial.ng is the best place to find your next perfect place to live.
          <br />
